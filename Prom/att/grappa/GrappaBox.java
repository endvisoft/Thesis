 ...
 * string-to-Rectangle2D and Rectangle2D-to-string conversions suitable for
 * Grappa.
 * 
...
public class GrappaBox extends java.awt.geom.Rectangle2D.Double {
	...
	/**
	 * Constructs and initializes a <code>GrappaBox</code> with upper-left
	 * coordinates (0,&nbsp;0) and zero width and height.
	 */
	public GrappaBox() {
	}

	/**
	 * Constructs and initializes a <code>GrappaBox</code> from a Rectangle2D
	 * 
	 * @param r
	 *            the rectangle defining the box (1-to-1 correspondence)
	 */
	 ...
	 * 
	 * @param x
	 *            ,&nbsp;y the upper-left position coordinates of the box
	 * @param width
	 *            ,&nbsp;height the size of the box
	 */
	...
	/**
	 * Constructs and initializes a <code>GrappaBox</code> with the coordinates
	 * derived from the specified String representation. When the
	 * <I>dimensioned</I> parameter is true, then the String format should be:
	 * "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>" otherwise it
	 * should be:
	 * "<I>x1-coord</I>,<I>y1-coord</I>,<I>x2-coord</I>,<I>y2-coord</I>"
	 * 
	 * @param coordString
	 *            String representing the coordinates to which to set the newly
	 *            constructed <code>GrappaBox</code>
	 * @param dimensioned
	 *            a boolean indicating the format of the string
	 */
	public GrappaBox(String coordString, boolean dimensioned) {
		...
		if (coords == null || coords.length != 4) {
			throw new IllegalArgumentException("coordinate string ("
					+ coordString + ") does not contain 4 valid coordinates");
		}
	 ...
	 * should be: "<I>x-coord</I>,<I>y-coord</I>,<I>width</I>,<I>height</I>""
	 * 
	 * @param coordString
	 *            String representing the coordinates to which to set the newly
	 *            constructed <code>GrappaBox</code>
	 ...
	 * 
	 * @param format
	 *            the format used to build the string (<TT>%b</TT> is the base
	 *            directive for a GrappaBox).
	...
	/**
	 * Returns true if the String format will be "x1,x2,width,height" or false
	 * if the format will be "x1,y1,x2,y2". The value is determined at creation
	 * time.
	 * 
	 * @return a boolean indicating the format of this Object's string
	 *         representation
	 */
