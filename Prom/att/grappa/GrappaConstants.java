...
/**
 * This class provides a common set of constant, class variables used by the
 * classes in the grappa package.
 * 
...
public interface GrappaConstants {
	/**
	 * arrow type arrays, added by little@2007.11.27
	 */
	public final static String[] ARROWTYPES = new String[] { "none", "normal",
			"tee", "odot", "diamond", "onormal" };
	/**
	...
	/**
	 * The new-line string for this system (as specified by the line.spearator
	 * property).
	 */
	...
	/*
	 * edit operations (NOT IMPLEMENTED YET) public final static int EDIT_UNDO =
	 * 0; public final static int EDIT_CUT = 1; public final static int
	 * EDIT_PASTE = 2; public final static int EDIT_COPY = 3; public final
	 * static int EDIT_DELETE = 4; public final static int EDIT_ADD = 5;
	 */
	...
	/**
	 * Maximum number of bits needed to represet the Element types. Element type
	 * is merged with the element id number (a sequentially assigned number) to
	 * ensure a unique identifier (within an invocation of the package).
	 * 
	 */
	...
	/**
	 * String name for custom class used to draw custom shapes (shapefile).
	 */
	public final static String CUSTOM_ATTR = "shapefile";
	/**
	 ...
	 */
	public final static String GRAPPA_BACKGROUND_COLOR_ATTR = Grappa.PKG_LOWER
			+ "BackgroundColor";
	/**
	 * String name for selection color attribute (grappaSelectionColor).
	 */
	public final static String GRAPPA_SELECTION_STYLE_ATTR = Grappa.PKG_LOWER
			+ "SelectionColor";
	/**
	 * String name for deletion color attribute (grappaDeletionColor).
	 */
	public final static String GRAPPA_DELETION_STYLE_ATTR = Grappa.PKG_LOWER
			+ "DeletionColor";
	/**
	 * String name for fontsize adjustment attribute (grappaFontsizeAdjustment).
	 */
	public final static String GRAPPA_FONTSIZE_ADJUSTMENT_ATTR = Grappa.PKG_LOWER
			+ "FontsizeAdjustment";
	/**
	...
	/**
	 * String name for minimum rank distance between head and tail of edges
	 * attribute [unused] (minlen).
	 */
	...
	/**
	 * String name for arrow type attribute (arrowhead). added by
	 * little@2007.11.27
	 */
	public final static String ARROWHEAD_ATTR = "arrowhead";
	public final static String ARROWTAIL_ATTR = "arrowtail";
	/**
	 ...
	 */
	public final static int GRAPPA_BACKGROUND_COLOR_HASH = GRAPPA_BACKGROUND_COLOR_ATTR
			.hashCode();
	/**
	 * Hash code for selection color attribute (grappaSelectionColor).
	 */
	public final static int GRAPPA_SELECTION_STYLE_HASH = GRAPPA_SELECTION_STYLE_ATTR
			.hashCode();
	/**
	 * Hash code for deletion color attribute (grappaDeletionColor).
	 */
	public final static int GRAPPA_DELETION_STYLE_HASH = GRAPPA_DELETION_STYLE_ATTR
			.hashCode();
	/**
	 * Hash code for fontsize adjustment attribute (grappaFontsizeAdjustment).
	 */
	public final static int GRAPPA_FONTSIZE_ADJUSTMENT_HASH = GRAPPA_FONTSIZE_ADJUSTMENT_ATTR
			.hashCode();
	/**
	...
	/**
	 * Hash code for minimum rank distance between head and tail of edges
	 * attribute (minlen).
	 */
	...
	/**
	 * Hash code for arrow type attribute. added by little@2007.11.27
	 */
	public final static int ARROWHEAD_HASH = ARROWHEAD_ATTR.hashCode();
	public final static int ARROWTAIL_HASH = ARROWTAIL_ATTR.hashCode();
	/**
	...
	/**
	 * Indicator that no attribute value type is specified. When no attribute
	 * type is specified, an error results.
	 */
	 ...
	 * representing an edge direction.
	 */
	...
	/**
	 * Indicator that attribute value is a java.lang.Integer representing a font
	 * style.
	 */
	public final static int FONTSTYLE_TYPE = 0x05;
	/**
	 * Indicator that attribute value is a java.lang.Hashtable whose keys
	...
	/**
	 * Indicator that attribute value is a java.lang.Integer representing a
	 * Grappa shape.
	 */
	 ...
	 */
	public final static int POLYGON_SHAPE = 17;
	/**
	 * Indicator that the element has a record shape. A record shape is of a box
	 * shape that contains one or more labelled sub-partitions within it.
	 */
	public final static int RECORD_SHAPE = 18;
	/**
	 * Indicator that the element has a box shape with rounded corners.
	 */
	public final static int ROUNDEDBOX_SHAPE = 19;
	/**
	 * Indicator that the element has a trapezium shape.
	 */
	public final static int TRAPEZIUM_SHAPE = 20;
	/**
	 * Indicator that the element has a triangle shape.
	 */
	public final static int TRIANGLE_SHAPE = 21;
	/**
	 * Indicator that the element has a triple octagon shape.
	 */
	public final static int TRIPLEOCTAGON_SHAPE = 22;
	/**
	 * Indicator that the element has a circular shape with parallel chords top
	 * and bottom.
	 */
	public final static int MCIRCLE_SHAPE = 23;
	/**
	 * Indicator that the element has a diamond shape with triangles inset in
	 * each corner.
	 */
	public final static int MDIAMOND_SHAPE = 24;
	/**
	 * Indicator that the element has a record shape with triangles inset in
	 * each of its four outer corners.
	 */
	public final static int MRECORD_SHAPE = 25;
	/**
	 * Indicator that the element has a square shape with triangles inset in
	 * each of its corners.
	 */
	public final static int MSQUARE_SHAPE = 26;
	/**
	 * Indicator that the element shape is determined by a user-supplied class
	 * defined by the "custom" attribute
	 */
	public final static int CUSTOM_SHAPE = 27;
	...
	/**
	 * Bit flag indicating that the shape path needs to be generated by by
	 * Grappa rather than relying on Java built-ins.
	 */
