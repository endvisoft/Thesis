...
public class EPCComplexityCalculator implements AnalysisPlugin {
	...
	public String getHtmlDescription() {
		...
		String header = "Plugin made by Joo Sobrinho and Daniel Teixeira on Univeristy of Madeira (http://www.uma.pt) to analyse Complexity of Business Processes modeled in EPC's.";
