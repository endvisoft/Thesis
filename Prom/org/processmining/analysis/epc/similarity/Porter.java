...
public class Porter {
	...
	private static final String[][] step2_suffixes = { { "ational", "ate" },
			{ "tional", "tion" }, { "enci", "ence" }, { "anci", "ance" },
			{ "izer", "ize" }, { "iser", "ize" }, { "abli", "able" },
	...
	private static final String[][] step3_suffixes = { { "icate", "ic" },
			{ "ative", "" }, { "alize", "al" }, { "alise", "al" },
	...
	private static final String[] step4_suffixes = { "al", "ance", "ence",
			"er", "ic", "able", "ible", "ant", "ement", "ment", "ent", "sion",
	...
	private static final String[] prefixes = { "kilo", "micro", "milli",
			"intra", "ultra", "mega", "nano", "pico", "pseudo" };
