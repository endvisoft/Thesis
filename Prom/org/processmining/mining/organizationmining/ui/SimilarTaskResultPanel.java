...
public class SimilarTaskResultPanel extends JPanel {
	...
	public SimilarTaskResultPanel(OrgModel orgmodel,
			SocialNetworkMatrix snmatrix, OrgMiningResult parent) {
		...
		menuPane.add(thresholdSlider, new GridBagConstraints(0, 2, 3, 1, 0.0,
				...
				new Insets(0, 0, 0, 0), 0, 0));
		/*
		 * menuPane.add(generateButton, new GridBagConstraints(0, 3, 4, 1, 0.0,
		 * 0.0 , GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0,
		 * 0, 0, 0), 0, 0)); generateButton.addActionListener(new
